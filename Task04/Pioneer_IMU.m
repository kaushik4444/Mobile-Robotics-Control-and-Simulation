...
if (connected)   
    while(true) % CHANGE THIS LINE TO 'while loop'
        ...
        del_s = vx * del_time + (curr_ax * del_time^2)/2 + 0.02; % distance travelled in a step
        ...
        curr_x = curr_x + del_s*cos(theta + del_theta);
        curr_y = curr_y + del_s*sin(theta + del_theta);
